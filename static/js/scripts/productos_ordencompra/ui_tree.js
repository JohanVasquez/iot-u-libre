/**
 * Created by Diego Monsalve on 12/07/17.
 */

var current = null;

// Función encargada de mostrar el modal para crear o renombrar un tipo de recurso
...
// Función que muestra el modal de confirmación para activar o desactivar tipo de recurso
function open_confirm_modal(action) {
    var modal_title = '';
    var message = '';
    if(action == 'activate'){
        modal_title = 'Activar tipo de recurso';
        message = '¿Está seguro que desea activar este tipo de recurso?';
    }else{
        modal_title = 'Desactivar tipo de recurso';
        message = '¿Está seguro que desea desactivar este tipo de recurso?';
    }
...
// Función encargada de validar el modal para crear/renombrar tipo de recurso
...
// Función encargada de registrar un nuevo tipo de recurso con ajax
        ...
        $.post(url,
            ...
            function(response){
                if(response['status']){
                    ...
                    toastr["success"]('Tipo de recurso registrado correctamente');
                }
            }
        );
    }
        ...
        $.post(url,
            ...
            function(response){
                if(response['status']){
                    ...
                    $("#modal_nuevo").modal('hide');
                    toastr["success"]('Tipo de recurso renombrado correctamente');
                }
            }
        );
    }
...
function cambiar_estado() {
    ...
    if(node.type == 'disabled'){
        event = 'activate';
        message = 'Tipo de recurso activado correctamente';
    }else{
        event = 'deactivate';
