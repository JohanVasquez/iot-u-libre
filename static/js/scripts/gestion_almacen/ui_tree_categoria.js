/**
 * Created by felix micolta on 19/10/17.
 */
/**
        ...
        $.post(url,
            ...
            function(response){
                if(response['status']){
                    ...
                    var data = {'text': nombre, 'id': id, 'type': 'leaf'};
        ...
        $.post(url,
            ...
            function(response){
                if(response['status']){
                    ...
                    $("#tree").jstree('rename_node', node , nombre);
                    $("#modal_nuevo").modal('hide');
...
$(document).ready(function () {
    ...
    $("#tree").on('select_node.jstree', function (event, object) {
        ...
        if (object.node.children == ''){
            current_product = {'pk': object.node.id, 'text': object.node.text};
        }else{
            current_product ='carpeta';
        }
